...
class GestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gest" do
    assert_difference('Gest.count') do
      post gests_url, params: { gest: { address: @gest.address, gender: @gest.gender, name: @gest.name, phone_number: @gest.phone_number, postcode: @gest.postcode } }
    end
  ...
  test "should update gest" do
    patch gest_url(@gest), params: { gest: { address: @gest.address, gender: @gest.gender, name: @gest.name, phone_number: @gest.phone_number, postcode: @gest.postcode } }
